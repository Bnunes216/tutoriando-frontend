...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Verificar se o email é user@gmail.com
    if (formData.email.toLowerCase() === 'user@gmail.com') {
  ...
  return (
    <>
      ...
      {/* Pop-up de usuário não encontrado */}
      <AlertDialog open={showUserNotFoundDialog} onOpenChange={setShowUserNotFoundDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Usuário não encontrado</AlertDialogTitle>
            <AlertDialogDescription>
              Este usuário não existe no sistema. Verifique seu email ou registre-se para criar uma nova conta.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => setShowUserNotFoundDialog(false)}>
              OK
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
